...
import com.smartlab.mobileapp.activity.DeleteBook;
import com.smartlab.mobileapp.activity.Detail;
import com.smartlab.mobileapp.connection.ConnectThread;
import com.smartlab.mobileapp.connection.OverItemT;
import com.smartlab.mobileapp.connection.ParkApp;
...
public class MainActivity extends MapActivity {
	...
	public double userLongitudeE6 = 0.0d;// 纬度
	public double userLatitudeE6 = 0.0d;// 经度
	...
	public void onCreate(Bundle savedInstanceState) {
			...
			public void onClick(View v) {
				...
				if (userLongitudeE6 != 0.0d || userLatitudeE6 != 0.0d) {
					...
					mMapView.getController().animateTo(
							new GeoPoint((int) (userLatitudeE6),
									(int) (userLongitudeE6)));
					mMapView.invalidate();
				} else {
				}
		...
		btn3.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent3=new Intent(MainActivity.this,DeleteBook.class);
				startActivity(intent3);
			
				//startActivityForResult(intent3, 0);
			}
		});
		ParkApp app = (ParkApp)getApplication();
		...
		GeoPoint point = new GeoPoint((int) (defaultLatitudeE6),
				(int) (defaultLongitudeE6)); // 用给定的经纬度构造一个GeoPoint，单位是微度 (度 *
												// 1E6)
	...
	private void showTips() {
		AlertDialog alertDialog = new AlertDialog.Builder(this)
				.setTitle("退出程序").setMessage("是否退出停车小助手？")
...
//	}
	...
	public class MyHandle extends Handler {
		...
		public void handleMessage(Message msg) {
			...
			switch (msg.what) {
			case 0:
				Toast.makeText(MainActivity.this, "没有获得服务器端数据",
			...
			case 1:
				...
				Drawable marker = getResources().getDrawable(
						R.drawable.icon_ar_tag); // 得到需要标在地图上的资源
				...
				overitem.addGeoPoint(mLat1, mLon1, "Parkname",
						"restamount，parkamount");
				mMapView.getOverlays().add(overitem); // 添加ItemizedOverlay实例到mMapView
				// 将目标地址移动到中心
				mMapView.getController().animateTo(
						new GeoPoint((int) (mLat1 * 1E6), (int) (mLon1 * 1E6)));
				mMapView.invalidate();
				break;
			default:
